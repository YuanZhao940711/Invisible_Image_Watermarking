...
class FullConv(nn.Module):
    def __init__(self, input_nc, output_nc, norm_layer, output_function):
        ...
        self.conv3 = conv3x3(c_in=64, c_out=128, norm=norm_layer) 
        self.conv4 = conv3x3(c_in=128, c_out=256, norm=norm_layer) 
        self.conv5 = conv3x3(c_in=256, c_out=512, norm=norm_layer) 
        self.conv6 = conv3x3(c_in=512, c_out=256, norm=norm_layer) 
        self.conv7 = conv3x3(c_in=256, c_out=128, norm=norm_layer) 
        self.conv8 = conv3x3(c_in=128, c_out=64, norm=norm_layer) 
